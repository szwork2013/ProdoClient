angular.module('prodo.ProdonusApp').value('cgNotifyTemplateName','angular-notify.html');
...
angular.module("prodo.ProdonusApp").run(["$templateCache", function($templateCache) {
