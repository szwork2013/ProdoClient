...
.controller('ProdoProductDashboardController', ['$scope', '$log', '$rootScope', 'UserSessionService', '$state', '$http', 'dashboardSliderData', 'allChartsData', function ($scope, $log, $rootScope,  UserSessionService, $state, $http, dashboardSliderData, allChartsData) {
    ...
    var cleanupeventGotChartContent = $scope.$on("gotChartDataSuccessfully", function(event, data){
     if(data.error !== undefined && data.error.code === 'AL001' )
        ...
        { 
            ...
            $state.transitionTo('prodo.productwall.wall-product.analytics.details');
        }
        else {
    ...
    $scope.backToAnalytics = function(){
      $scope.viewDetailChart = false;
      $state.transitionTo('prodo.productwall.wall-product.analytics');
    }
