...
.factory("prodoCommentService",['$rootScope', '$resource', '$http', '$state', '$log', function($rootScope, $resource, $http, $state, $log) {

var searchService=
{
Product : $resource('/api/profileinfo/:userid',{},
{
searchUser : { method: 'GET', params: { userid : '@userid' }},
})
};
...
searchService.Product.searchUser({userid: userData},
function(success) {
$log.debug(success);
